...
public class MenuBarAppender {
	...
	public static void updateHeight() {
		...
		if(menuBar == null) {
			SystemConfigTable.MENU_BAR_HEIGHT = 0;
		}
		SystemConfigTable.MENU_BAR_HEIGHT = menuBar.getHeight();
		GlobalConfiguration.ratio_x = JFMainWindow.getWidth() * 1.0 / GlobalConfiguration.GRID_HORIZONTAL_NUM;
		GlobalConfiguration.ratio_y = (JFMainWindow.getHeight() - SystemConfigTable.MENU_BAR_HEIGHT) * 1.0 / GlobalConfiguration.GRID_VERTICAL_NUM;
